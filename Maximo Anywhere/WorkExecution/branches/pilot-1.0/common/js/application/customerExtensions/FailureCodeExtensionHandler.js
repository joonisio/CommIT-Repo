...
define("application/customerExtensions/FailureCodeExtensionHandler", 
	   [ "dojo/_base/declare",
	     "dojo/_base/array",
		  "dojo/_base/lang",
		  "dojo/dom-class",
...
/**@memberOf application.handlers.FailureCodeHandler */
		...
		failureLookup: function(eventContext){
			...
			var woSet = eventContext.application.getResource('childWorkOrder');
		...
		_getCurrentWO :  function(eventContext){
			return currWO = eventContext.application.getResource('childWorkOrder').getCurrentRecord();
		},
		...
		commitFailureCode : function(eventContext){
			eventContext.application.showBusy();			
			var currWOSet = eventContext.application.getResource('childWorkOrder');
		...
		handleFailureLookupBackButtonClick : function(eventContext){
			this.application.showBusy();
			var self=this;
			var wo = eventContext.application.getResource('childWorkOrder').getCurrentRecord();
			...
			var handler = eventContext.application['application.customerExtensions.FailureCodeExtensionHandler'];
